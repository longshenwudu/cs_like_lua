...
namespace Morozov.Parsing
{
    ...
    public class MyParserContext
    {
        ...
        public  System.Collections.Generic.LinkedList<string> ts = new System.Collections.Generic.LinkedList<string>();



        public System.Collections.Generic.LinkedList<string> @using = new System.Collections.Generic.LinkedList<string>();
        public ASTNode CreateASTNode()
        {
            ...
            switch (m_parser.ReductionRule.Index)
            {
                ...
                case (int)RuleConstants.RULE_VALIDID_IDENTIFIER:
                    ...
                    ts.AddLast(token1a);
                    return new Test.TypeDef(Token(0));
                ...
                case (int)RuleConstants.RULE_QUALIFIEDID:
                    try
                    {
                        ...
                        {
                         var   tsx = ts;
                            var new_t = new Test.TypeDef(tsx);
                            //     if (ts.Last.Value!= "----------")
                            //   ts.AddAfter(ts.Last,         
                           //"----------");
                            return new_t;
                ...
                case (int)RuleConstants.RULE_MEMBERLIST_MEMBERNAME:
                    ...
                    //       ts.AddLast(token1);
                     ...
                     ts.AddLast(token1);
                    var rr = Token(1);
                    return new Test.TypeDef(token1);//null;
                ...
                case (int)RuleConstants.RULE_VARIABLEDECLARATOR_IDENTIFIER:
                    ...
                    return new Test.TypeDef(str_to1);//null;
              ...
              //      Console.WriteLine(str);
                    ...
                    @using.AddLast(str);
                    //构建引用;
                    //if(t2.vs.ContainsKey("m"))
                    //{
                    //    Console.WriteLine(t2.name + "..." + t2.vs["m"]);
                    //}else
                    //{
                    //    Console.WriteLine(t2.name);
                    //}

                    return new Test.TypeDef(@using);
                ...
                case (int)RuleConstants.RULE_ACCESSOPT_PRIVATE:
                    //<Access Opt> ::= private
                    //todo: Perhaps create an object in the AST.
                    //   Console.WriteLine("开始创建[>"+Token(0));
                    return null;
                ...
                case (int)RuleConstants.RULE_ACCESSOPT:
                    //<Access Opt> ::= 
                    //todo: Perhaps create an object in the AST.
                    Console.WriteLine("开始创建[>一个无访问符class");
                    return null;
                ...
                case (int)RuleConstants.RULE_CLASSDECL_CLASS_IDENTIFIER_LBRACE_RBRACE:
                    ...
                    Console.Write("开始创建类[>" + Token(0) + Token(2));
                    if (Token(6) == "}")
                    {
                        Console.Write(",构建完成\n");
                      //  ts.AddFirst("--------");
        ...
        public Test.TypeDef type(int index)
        {

            return (Test.TypeDef)m_parser.GetReductionSyntaxNode(index);
            ...
            while (true)
            {
                switch (parser.Parse())
                {
                    ...
                    case ParseMessage.Reduction:
                        ...
                        parser.TokenSyntaxNode = m_context.CreateASTNode();
                        break;
                    ...
                    case ParseMessage.Accept:
                        ...
                        var m_program = (Test.TypeDef)parser.TokenSyntaxNode;
                        return true;
